{
  ...
  '#spec':: d.obj(help='"Spec is the information to identify the update request."'),
  spec: {
    ...
    '#resource':: d.obj(help='"ResourceSpec is the information to identify the update request."'),
    resource: {
