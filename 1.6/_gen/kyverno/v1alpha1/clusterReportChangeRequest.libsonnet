{
  ...
  results: {
    ...
    '#withData':: d.fn(help='"Data provides additional information for the policy rule"', args=[d.arg(name='data', type=d.T.object)]),
    withData(data): { data: data },
    '#withDataMixin':: d.fn(help='"Data provides additional information for the policy rule"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='data', type=d.T.object)]),
