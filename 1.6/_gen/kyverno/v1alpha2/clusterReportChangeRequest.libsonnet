{
  ...
  '#':: d.pkg(name='clusterReportChangeRequest', url='', help='"ClusterReportChangeRequest is the Schema for the ClusterReportChangeRequests API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterReportChangeRequest', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  results: {
    ...
    '#resources':: d.obj(help='"Resources is an optional reference to the resource checked by the policy and rule"'),
    resources: {
    ...
    '#withMessage':: d.fn(help='"Message is a short user friendly description of the policy rule"', args=[d.arg(name='message', type=d.T.string)]),
    withMessage(message): { message: message },
    '#withPolicy':: d.fn(help='"Policy is the name of the policy"', args=[d.arg(name='policy', type=d.T.string)]),
    ...
    '#withResources':: d.fn(help='"Resources is an optional reference to the resource checked by the policy and rule"', args=[d.arg(name='resources', type=d.T.array)]),
    withResources(resources): { resources: if std.isArray(v=resources) then resources else [resources] },
    '#withResourcesMixin':: d.fn(help='"Resources is an optional reference to the resource checked by the policy and rule"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resources', type=d.T.array)]),
    ...
    '#withRule':: d.fn(help='"Rule is the name of the policy rule"', args=[d.arg(name='rule', type=d.T.string)]),
    withRule(rule): { rule: rule },
    '#withScored':: d.fn(help='"Scored indicates if this policy rule is scored"', args=[d.arg(name='scored', type=d.T.boolean)]),
  ...
  scope: {
    '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
    withApiVersion(apiVersion): { scope+: { apiVersion: apiVersion } },
    '#withFieldPath':: d.fn(help='"If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: \\"spec.containers{name}\\" (where \\"name\\" refers to the name of the container that triggered the event) or if no container name is specified \\"spec.containers[2]\\" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object. TODO: this design is not final and this field is subject to change in the future."', args=[d.arg(name='fieldPath', type=d.T.string)]),
    withFieldPath(fieldPath): { scope+: { fieldPath: fieldPath } },
    '#withKind':: d.fn(help='"Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
    withKind(kind): { scope+: { kind: kind } },
    '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { scope+: { name: name } },
    '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
    withNamespace(namespace): { scope+: { namespace: namespace } },
    '#withResourceVersion':: d.fn(help='"Specific resourceVersion to which this reference is made, if any. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency"', args=[d.arg(name='resourceVersion', type=d.T.string)]),
    withResourceVersion(resourceVersion): { scope+: { resourceVersion: resourceVersion } },
    '#withUid':: d.fn(help='"UID of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#uids"', args=[d.arg(name='uid', type=d.T.string)]),
    withUid(uid): { scope+: { uid: uid } },
  },
  '#scopeSelector':: d.obj(help='"ScopeSelector is an optional selector for multiple scopes (e.g. Pods). Either one of, or none of, but not both of, Scope or ScopeSelector should be specified."'),
  scopeSelector: {
    '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
    matchExpressions: {
      '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
    withMatchLabels(matchLabels): { scopeSelector+: { matchLabels: matchLabels } },
    '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
    withMatchLabelsMixin(matchLabels): { scopeSelector+: { matchLabels+: matchLabels } },
  },
  ...
  summary: {
    ...
    withError(err): { summary+: { 'error': err } },
    ...
    withSkip(skip): { summary+: { skip: skip } },
    '#withWarn':: d.fn(help='"Warn provides the count of unscored policies whose requirements were not met"', args=[d.arg(name='warn', type=d.T.integer)]),
    withWarn(warn): { summary+: { warn: warn } },
  },
