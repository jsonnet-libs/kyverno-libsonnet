{
  ...
  '#':: d.pkg(name='reportChangeRequest', url='', help='"ReportChangeRequest is the Schema for the ReportChangeRequests API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReportChangeRequest', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
